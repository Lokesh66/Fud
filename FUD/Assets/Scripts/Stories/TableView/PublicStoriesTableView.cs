...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class PublicStoriesTableView : GridAdapter<GridParams, PublicStoryCellViewHolder>, ILazyListSimpleDataManager<StoryModel>
	{
		...
		public MyStoriesBrowseView adataObject;
		...
		protected override void UpdateCellViewsHolder (PublicStoryCellViewHolder viewsHolder)
		{
			var model = Data [viewsHolder.ItemIndex];

			viewsHolder.views.gameObject.transform.parent.GetComponent<PublicStoryCell> ().SetView (model, adataObject.OnStoryTapAction);
	...
	public class PublicStoryCellViewHolder : CellViewsHolder
	{
