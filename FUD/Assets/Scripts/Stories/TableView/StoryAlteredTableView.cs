...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class StoryAlteredTableView : GridAdapter<GridParams, StoryAlteredCellViewHolder>, ILazyListSimpleDataManager<StoryAlteredModel>
	{

		public UnityEngine.Events.UnityEvent OnItemsUpdated;

		private LazyList<StoryAlteredModel> _Data;

		public LazyList<StoryAlteredModel> Data { get { return _Data; } private set { _Data = value; } }

		public StoriesAlteredView adataObject;
		...
		{
			Data = new LazyList<StoryAlteredModel> (CreateNewModel, adataObject.modelsList.Count);
		}
		...
		StoryAlteredModel CreateNewModel (int index)
		{
			return adataObject.modelsList [index];
		}
		...
		protected override void UpdateCellViewsHolder (StoryAlteredCellViewHolder viewsHolder)
		{
