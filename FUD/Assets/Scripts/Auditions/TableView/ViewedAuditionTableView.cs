...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class ViewedAuditionTableView : GridAdapter<GridParams, ShortListedViewCellHolder>, ILazyListSimpleDataManager<SearchAudition>
	{
		...
		public ViewedAuditionsView adataObject;
	...
	public class ViewedAuditionViewCellHolder : CellViewsHolder
	{
