...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class ShortListedAuditionTableView : GridAdapter<GridParams, ShortListedViewCellHolder>, ILazyListSimpleDataManager<SearchAudition>
	{
		...
		public ShortListedAuditionView adataObject;
		...
		protected override void UpdateCellViewsHolder (ShortListedViewCellHolder viewsHolder)
		{
	...
	public class ShortListedViewCellHolder : CellViewsHolder
	{
