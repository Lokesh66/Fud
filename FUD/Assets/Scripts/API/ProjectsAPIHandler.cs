...
public partial class APIHandler
{
    ...
    {
        gameManager.StartCoroutine(GetRequest(APIConstants.CREATE_PROJECT, (bool status, string response) => {
    ...
    public void CreateProject(Project project, Action<Project> action)
    {
        ...
        gameManager.StartCoroutine(PostRequest(APIConstants.CREATE_PROJECT, parameters, (bool status, string response) => {
