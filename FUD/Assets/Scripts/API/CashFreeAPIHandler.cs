...
public partial class APIHandler
{
    ...
    public void CashFreeRequest (string customerPhone, string customerEmail, string customerName = null, string orderNote = null)
    {
        gameManager.apiHandler.GetRequest (APIConstants.GET_CASH_FREE_TOKEN, true, (bool status, string responseString) => 
        {
            if (status)
            {
                ...
                paymentActivity.CallStatic ("doPayment", currentActivity, paramObj, response.token, GetProductionKey());
