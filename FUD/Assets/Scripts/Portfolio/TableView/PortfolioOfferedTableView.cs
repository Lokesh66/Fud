...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class PortfolioOfferedTableView : GridAdapter<GridParams, PortfolioOfferedCellHolder>, ILazyListSimpleDataManager<PortfolioActivityModel>
	{
		...
		public PortfolioOfferedView adataObject;
		...
		protected override void UpdateCellViewsHolder (PortfolioOfferedCellHolder viewsHolder)
		{
	...
	public class PortfolioOfferedCellHolder : CellViewsHolder
	{
