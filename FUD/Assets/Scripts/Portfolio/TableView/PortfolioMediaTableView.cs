...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	public class PortfolioMediaTableView : GridAdapter<GridParams, PortfolioMediaCellHolder>, ILazyListSimpleDataManager<PortfolioModel>
	{
		...
		public PortfolioMediaView adataObject;
		...
		{
			Data = new LazyList<PortfolioModel> (CreateNewModel, adataObject.portfolioModels.Count);
		}
		...
		protected override void UpdateCellViewsHolder (PortfolioMediaCellHolder viewsHolder)
		{
	...
	public class PortfolioMediaCellHolder : CellViewsHolder
	{
