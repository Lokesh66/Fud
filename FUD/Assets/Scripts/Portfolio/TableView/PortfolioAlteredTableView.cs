...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class PortfolioAlteredTableView : GridAdapter<GridParams, PortfolioAlteredCellHolder>, ILazyListSimpleDataManager<PortfolioActivityModel>
	{

		public UnityEngine.Events.UnityEvent OnItemsUpdated;

		private LazyList<PortfolioActivityModel> _Data;

		public LazyList<PortfolioActivityModel> Data { get { return _Data; } private set { _Data = value; } }

		public PortfolioAlteredView adataObject;
		...
		{
			Data = new LazyList<PortfolioActivityModel> (CreateNewModel, adataObject.activityModels.Count);
		}
		...
		PortfolioActivityModel CreateNewModel (int index)
		{
		...
		protected override void UpdateCellViewsHolder (PortfolioAlteredCellHolder viewsHolder)
		{
	...
	public class PortfolioAlteredCellHolder : CellViewsHolder
	{
