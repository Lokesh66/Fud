...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	public class UpdateSceneAlbumsTableView : GridAdapter<GridParams, UpdateSceneAlbumCellHolder>, ILazyListSimpleDataManager<SceneCharacter>
	{
		...
		protected override void Start ()
		{
			...
			canAddSceneCharacters = adataObject.canAddCharacters;
		}
		...
		protected override void UpdateCellViewsHolder (UpdateSceneAlbumCellHolder viewsHolder)
		{
	...
	public class UpdateSceneAlbumCellHolder : CellViewsHolder
	{
