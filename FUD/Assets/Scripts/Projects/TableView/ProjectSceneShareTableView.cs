...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class ProjectSceneShareTableView : GridAdapter<GridParams, SceneShareCellHolder>, ILazyListSimpleDataManager<SceneAlbumModel>
	{
		...
		public ProjectSceneShareView adataObject;
		...
		protected override void UpdateCellViewsHolder (SceneShareCellHolder viewsHolder)
		{
			var model = Data [viewsHolder.ItemIndex];

			viewsHolder.views.gameObject.transform.parent.GetComponent<SceneAlbumCell> ().SetView (model, adataObject.OnCellButtonAction, adataObject.OnSelectMember);
	...
	public class SceneShareCellHolder : CellViewsHolder
	{
