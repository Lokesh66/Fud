...
namespace frame8.ScrollRectItemsAdapter.GridExample
{
	...
	/// </summary>
	public class ProjectBrowseTableView : GridAdapter<GridParams, ProjectBrowseMediaCellHolder>, ILazyListSimpleDataManager<PortfolioModel>
	{
		...
		public LazyList<PortfolioModel> Data { get { return _Data; } private set { _Data = value; } }

		public ProjectBrowserView adataObject;
		...
		{
			Data = new LazyList<PortfolioModel> (CreateNewModel, adataObject.albumModels.Count);
		}
		...
		{
			return adataObject.albumModels [index];
		}
		...
		protected override void UpdateCellViewsHolder (ProjectBrowseMediaCellHolder viewsHolder)
		{
	...
	public class ProjectBrowseMediaCellHolder : CellViewsHolder
	{
