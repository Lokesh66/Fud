...
public class UpdateSceneManualView : MonoBehaviour
{
    ...
    UpdateSceneCharacterView updateSceneView;
    ...
    public void EnableView(List<SceneCharacter> sceneCharacters, UpdateSceneCharacterView updateSceneView)
    {
    ...
    {
        updateSceneView.SetManualDialogues(dialogues);
