...
namespace Paroxe.PdfRenderer
{
    ...
    public class PDFSearchHandle : IDisposable
    {
            ...
            MatchOption flags = MatchOption.NONE)
        {
            ...
            m_NativePointer = FPDFText_FindStart(textPage.NativePointer, unmanagedPointer, (uint)flags, startIndex);
        ...
        private static extern IntPtr FPDFText_FindStart(IntPtr text_page, IntPtr buffer, uint flags, int start_index);
