...
namespace Paroxe.PdfRenderer
{
    ...
    public class PDFDest : IDisposable
    {
        ...
        public int PageIndex
        {
            ...
            {
                if (m_PageIndex < 0)
                    m_PageIndex = (int)FPDFDest_GetDestPageIndex(m_Document.NativePointer, m_NativePointer);
                return m_PageIndex;
            }
        }
...
#region NATIVE
        ...
        private static extern uint FPDFDest_GetDestPageIndex(IntPtr document, IntPtr dest);
#endregion
    }
#endif
}