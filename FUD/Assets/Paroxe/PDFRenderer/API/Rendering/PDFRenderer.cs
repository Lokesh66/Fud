...
namespace Paroxe.PdfRenderer
{
	...
	public class PDFRenderer : IDisposable
	{
			...
			IPDFColoredRectListProvider rectsProvider, RenderSettings settings)
		{
			...
			FPDF_RenderPageBitmapWithMatrix(m_Bitmap.NativePointer, page.NativePointer, ref matrix, ref clipping, flags);
        ...
        [DllImport(PDFLibrary.PLUGIN_ASSEMBLY)]
        public static extern void FPDF_RenderPageBitmapWithMatrix(IntPtr bitmap, IntPtr page, ref PDFMatrix matrix, ref PDFRect clipping, int flags);
#endif
        #endregion
    }
}