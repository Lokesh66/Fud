    ...
    public class PDFDocument : IPDFDocumentInternal, IDisposable
    {
        ...
        private void CommonInit(byte[] buffer, string password)
        {
            ...
            if (m_DocumentBuffer != null)
            {
                ...
                m_NativePointer = FPDF_LoadMemDocument(m_BufferHandle.AddrOfPinnedObject(), m_DocumentBuffer.Length, password);
#endif
        ...
        private static extern IntPtr FPDF_LoadMemDocument(IntPtr data_buf, int size, string password);
